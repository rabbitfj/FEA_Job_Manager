...
#Root info collect
notepadpath='C:\\Program Files\\npp.7.5.1.bin.x64\\notepad++.exe'
hmpath="D:\\Program Files\\Altair\\13.0\\hm\\bin\\win64\\hmopengl.exe"
startupfolder='c:\\Job_Manager\\startup\\'
...
class Main(QMainWindow, Ui_MainWindow):    
    ...
    def __init__(self):
        ...
        self.new_Job_info=[]
        self.setupUi(self) 
        self.exist_status={}  #file:0/1  0 for no,1 for yes
        ...
        Product_CB_list=['CEM','C_pkg','Muffler','Other']
        Jobtype_CB_list=['Gload','Mode','PreT','Lifting']
    ...
    def Createcase(self):
        ...
        if self.Machine_type_CB.currentText()=='None':
            ...
            if Job_number=='':
                ...
                new_file=self.model_folder+new_main_file
                ...
                '''Create basic job info in database'''
                self.new_Job_info=[self.njobno,basenumber,user,time.ctime(),time.ctime(),self.Job_info[5],self.Job_info[6],self.Job_info[7],self.Job_info[8],self.Job_info[9],self.Job_info[10],self.Job_info[11],self.Job_info[12]]
    ...
    def Getallinput(self):
        ...
        if self.New_Machine_type=='None':
            ...
            if self.New_Machine=='':
                ...
                #print('New job info',self.new_Job_info)
...
''' % (MK_info_s,IK_info_s) 
    ...
    def Opennp(self,path):
        ...
        with open(startupfolder+notepadsrp,'w') as f:
